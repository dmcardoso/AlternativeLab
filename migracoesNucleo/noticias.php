...
$conOrigem = new PDO("mysql:dbname=carmo_rio_verde_antigo;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));

$conDestino = new PDO("mysql:dbname=prefeitura_carmo_rio_verde;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));
...
try {
    ...
    $categorias = "SELECT * FROM categorias_not";
    ...
    foreach ($result as $noticia) {
        ...
        $stmMidias = $conOrigem->prepare("SELECT * FROM anexos WHERE post=?");
