...
$conOrigem = new PDO("mysql:dbname=mozarlandia_nucleo;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));

$conDestino = new PDO("mysql:dbname=mozarlandia_padrao;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));
...
try {
    ...
    $categorias = "SELECT * FROM tb_categorias_not";
    ...
    $noticias = "SELECT * FROM tb_noticias";
    ...
    foreach ($result as $noticia) {
        ...
        try {
            ...
            $stmNewNot = $conDestino->prepare("INSERT INTO noticias (dir, titulo, texto, galeria, data, capa) VALUES (?,?,?,?,?,?)");
            $stmNewNot->bindValue(1, $dirNoticia);
            $stmNewNot->bindValue(2, $t);
            $stmNewNot->bindValue(3, strip_tags($txt, "<p><a><b><strong><br><img><iframe>"));
            $stmNewNot->bindValue(4, $idGaleria);
            $stmNewNot->bindValue(5, $data);
            $stmNewNot->bindValue(6, $idCapa);
            ...
            try {
                ...
                echo "<br>Linha " . $noticia["id"] . " falhou novamente.<br><br>";
            }
        }
        ...
        $stmMidias = $conOrigem->prepare("SELECT * FROM tb_anexos WHERE post=?");
