...
//        $galerias = [];
        ...
        foreach ($result as $i => $v) {
            ...
            if(strstr($video,"v=") != false){
                ...
                if(strstr($video,"&") != false){
                    $cod_video = explode("&", $cod_video)[0];
                }

                if($cod_video != null){
                    $novo_nome = md5($cod_video);
                    $arquivo_move_capa = "novo/{$relacao_pasta}{$post_id}_capa_{$novo_nome}.jpg";

                    if (file_exists($arquivo_move_capa)) {
                        $conta = 0;
                        while (file_exists($arquivo_move_capa)) {
                            $conta++;
                            $titulo_capa = md5($cod_video . $conta);
                            $arquivo_move_capa = "novo/{$relacao_pasta}{$post_id}_capa_{$titulo_capa}.jpg";
                        }
                    }

                    copy("https://i.ytimg.com/vi/{$cod_video}/hqdefault.jpg", $arquivo_move_capa);
                    echo "Vídeo {$post_id} : SUCESSO!" . "<br>";
                }
            }else{
                echo "Vídeo Inválido <br>";
                continue;
            }
    ...
    echo "{$contadorVideos} vídeos migrados <br>";
