...
//                print_r($result_post);
                    ...
                    if (isset($result_post[0])) {
                        ...
                        if ($type_midia == "capa") {
                            $query_relacao_post_capa = $conDestino->prepare("INSERT INTO wp_postmeta(meta_id, post_id, meta_key, meta_value) values(null, ?,'miniatura', ?)");
...
//
                            ...
                            $query_relacao_post_miniatura = $conDestino->prepare("INSERT INTO wp_postmeta(meta_id, post_id, meta_key, meta_value) values(null, ?,'_miniatura', 'field_5b5ec69578a1c')");
...
//
    ...
    if (count($galerias) > 0) {
        ...
        foreach ($galerias as $i => $v) {
            ...
            $query_relacao_post_capa = $conDestino->prepare("INSERT INTO wp_postmeta(meta_id, post_id, meta_key, meta_value) values(null, ?,'galeria', ?)");
            $query_relacao_post_capa->bindValue(1, $i);
            $query_relacao_post_capa->bindValue(2, $galeria);
//
            $query_relacao_post_capa->execute();

            $query_relacao_galeria = $conDestino->prepare("INSERT INTO wp_postmeta(meta_id, post_id, meta_key, meta_value) values(null, ?,'_galeria', 'field_5b5ec6a178a1d')");
