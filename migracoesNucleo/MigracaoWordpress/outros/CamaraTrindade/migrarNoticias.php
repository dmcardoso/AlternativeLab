...
$conOrigem = new PDO("mysql:dbname=camara_trindade;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));

$conDestino = new PDO("mysql:dbname=camara_trindade_nucleoweb;host=localhost", "root", "1234", $options = array(
    PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8',
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_PERSISTENT => false
));
...
try {
    ...
    $query = $conOrigem->prepare("
        SELECT
            title as titulo, text as texto, SUBSTR(image, 10) as capa, date as data, slug
        FROM
            core_noticia "
    );
